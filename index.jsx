const data=[
    {title:'BLACK JACK',desc:'플레잉 카드로 즐길 수 있는 카지노 게임류의 일종이다. 21에 가까이 만들면 이기는 게임이다.딜러에게 카드를 한장씩 받아 21에 가까운 수를 만드는 사람이 이기며 21을 초과하면 지는 게임.',img:'https://extrabetamerica.imgix.net/shutterstock_1912987084_40fb028413.jpg?fit=crop&ar=4:3',clip:'https://www.youtube.com/embed/PljDuynF-j0',link:''},
...
const jcode=(
    <div>
        ...
        <div>
            <p>{data[0].desc}</p>
            <img src="{data[0].img}" alt="blackjack" />
